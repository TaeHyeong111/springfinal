...
public class CarMain {
	public static void main(String[] args) {
		...
		aBox.add(new Avante("아반떼", 1500));
		aBox.add(new Avante("아반떼", 1800));
		aBox.add(new Avante("아반떼", 2000));
		...
		cBox.add(new Avante("bmwa", 1900));
		cBox.add(new Avante("bmwb", 2500));
		cBox.add(new Avante("bmwc", 4000));
